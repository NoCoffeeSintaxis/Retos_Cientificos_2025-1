...
# Datos medidos (dx y dy en cm)
dx = np.arange(66)

dy = np.array([
            0.00, 0.15, -0.34, 1.56, 1.60, 2.63, 3.50, 4.33, 4.96, 5.03,
            5.56, 6.36, 7.40, 7.26, 7.86, 8.30, 8.60, 8.96, 9.43, 9.83,
            10.03, 10.16, 10.83, 11.03, 11.36, 11.70, 11.96, 12.10, 12.26, 12.66,
            13.33, 13.46, 13.80, 14.20, 14.46, 14.73, 14.76, 15.40, 15.93, 16.06,
            16.26, 16.50, 16.50, 16.76, 17.46, 17.60, 17.83, 18.03, 18.20, 19.46,
            18.80, 19.16, 19.03, 19.20, 19.43, 19.60, 19.70, 20.03, 20.30, 20.36,
            20.83, 20.76, 21.60, 21.96, 21.90, 22.53
            ])
...
def sphere_profile(r, R=3, h_min=0.05):
...
# Asignar esfera pura en la parte interna (0 a 1.5 cm)
dy_final[pure_sphere_region] = dy_sphere[pure_sphere_region]

# Blending suave entre 1.5 y 4 cm
...
# Ahora generamos los puntos corregidos cada 0.1 cm
